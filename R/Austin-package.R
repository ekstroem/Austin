...
#' @docType package
#' @author Claus Thorn Ekstrøm \email{ekstrom@@sund.ku.dk}\cr Maintainer: Claus Thorn Ekstrøm \email{ekstrom@@sund.ku.dk}
#' @references Ekstrøm, C. (2017). The R Primer. Chapman & Hall, 2nd edition.
